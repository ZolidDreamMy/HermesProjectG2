...
<head>
    ...
    <script src="loadcheckin.js"></script>
</head>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <div class="input-group mb-3">
                                                ...
                                                <button type="button" class="btn btn-round btn-fill btn-info" id="btnSearch" onclick="btnSearch_Click()">Search</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    var urlAPI = "http://localhost/project_HeremsG2/hermesdb/apicheckin.php/getdb/" + dataCheck;
