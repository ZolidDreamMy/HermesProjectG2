$(() => {
    ...
    $("#next").click(function (e) {
        ...
        var url = "http://localhost/hermes/projectHermes/api.php/updateReservation" + query + "&id=248";
        alert("url :" + url);
        getjson(url);
    });
...
function update(){
    alert("del_complete");
    window.location.replace("http://localhost/project_HeremsG2/hermesdb/api.php/del/{resinfo_id}")
}